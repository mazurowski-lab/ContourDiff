...
def main(args):
    ...
    df_train_meta = pd.read_csv(os.path.join(args.data_directory, args.output_domain, "df_meta.csv"), index_col=0)
    df_val_meta = pd.read_csv(os.path.join(args.data_directory, args.input_domain, "df_meta.csv"), index_col=0)
    ...
    train_dataset = ContourDiffDataset(
        df_train_meta, 
        image_directory=os.path.join(args.data_directory, args.output_domain, "images"),
        contour_directory=os.path.join(args.data_directory, args.output_domain, "contours"),
    ...
    val_dataset = ContourDiffDataset(
        df_val_meta, 
        image_directory=os.path.join(args.data_directory, args.input_domain, "images"),
        contour_directory=os.path.join(args.data_directory, args.input_domain, "contours"),
